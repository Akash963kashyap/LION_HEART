...
export class Classprofile extends Component {
  ...
  async componentDidMount() {
    const data = await fetch("https://api.github.com/users/Akash963kashyap");
