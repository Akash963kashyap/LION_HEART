  ...
  return (
    ...
    <div className="home-up-img">
      <div className="home-mid-img">
        ...
        <div className="home-title">LION <span>_HEART</span></div>
    ...
    <div>
        ...
        <p className="low-desc">From swanky upscale restaurants to the cosiest hidden gems serving the most incredible food, Lion heart covers it all. Explore menus, and millions of restaurant photos and reviews from users just like you, to find your next great meal.</p>
    </div>
  </div>
  )
}
